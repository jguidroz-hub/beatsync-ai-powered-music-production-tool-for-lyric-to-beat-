...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">Here's your BeatSync - AI-powered music production tool for lyric-to-beat alignment overview.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
          <a href="/dashboard/projects" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            ...
            <p className="text-sm text-gray-500">List and manage music production projects</p>
          </a>
          <a href="/dashboard/projects/[projectId]" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            <h3 className="font-medium">Project Details</h3>
            <p className="text-sm text-gray-500">Detailed view of a specific music project</p>
          </a>
