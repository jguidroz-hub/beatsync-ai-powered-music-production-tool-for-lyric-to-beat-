  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="BeatSync - AI-powered music production tool for lyric-to-beat alignment-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
