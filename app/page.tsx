  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">BeatSync - AI-powered music production tool for lyric-to-beat alignment</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Automatically syncs lyrics to instrumental sections with timestamp tracking, eliminating manual work for producers and rappers in song creation workflow.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust BeatSync - AI-powered music production tool for lyric-to-beat alignment.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} BeatSync - AI-powered music production tool for lyric-to-beat alignment. All rights reserved.</p>
