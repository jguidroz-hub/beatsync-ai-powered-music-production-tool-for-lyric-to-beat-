...
const FROM = process.env.EMAIL_FROM || 'BeatSync - AI-powered music production tool for lyric-to-beat alignment <noreply@example.com>';
const APP_NAME = 'BeatSync - AI-powered music production tool for lyric-to-beat alignment';
